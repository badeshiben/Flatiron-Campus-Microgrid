...
tic
set_param('BESS_validation/FC_BESS', 'cc_kp', num2str(x(1)));
set_param('BESS_validation/FC_BESS', 'cc_Ti', num2str(x(2)));
set_param('BESS_validation/FC_BESS', 'pll_kp', num2str(x(3)));
set_param('BESS_validation/FC_BESS', 'pll_ki', num2str(x(4)));

%% Run simulation
out = sim('BESS_validation');
